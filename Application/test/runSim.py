...
if options.sim=="G4":
    ...
    process.UniformMagneticFieldESProducer.ZFieldInTesla = cms.double(options.bvalue)
    ...
    process.g4SimHits.UseParametrisedEMPhysics = False
    process.g4SimHits.Physics.CutsPerRegion = False
    process.g4SimHits.Physics.CutsOnProton  = False
    process.g4SimHits.Physics.DefaultCutValue = 0.1
    process.g4SimHits.Physics.G4BremsstrahlungThreshold = 0.5
    process.common_maximum_time.MaxTrackTime = 10000.0
    process.common_maximum_time.DeadRegions = []
    process.common_maximum_time.CriticalDensity = 0
    process.common_maximum_time.CriticalEnergyForVacuum = 0
    process.g4SimHits.StackingAction.TrackNeutrino = True
    process.g4SimHits.StackingAction.MaxTrackTime = 10000.0
    ...
    process.g4SimHits.SteppingAction.MaxTrackTime = 10000.0
    ...
    process.g4SimHits.SteppingAction.CriticalDensity = 0
    process.g4SimHits.SteppingAction.CriticalEnergyForVacuum = 0
    process.g4SimHits.CaloSD.TmaxHit = 10000.0
    process.g4SimHits.CaloSD.TmaxHits = [10000.0,10000.0,10000.0,10000.0,10000.0]
...
# modules for GeantV
    ...
    process.geantv = cms.EDProducer("GeantVProducer",
        ...
        geometry = cms.string(""),
        ZFieldInTesla = cms.double(options.bvalue),
        Scoring = scoring_,
    )
